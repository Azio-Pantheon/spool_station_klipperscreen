        ...
        for section in config:
            ...
            if section == 'main':
                bools = (
                    ...
                    'show_heater_power', "show_scroll_steppers", "auto_open_extrude", 'enable_prime', 'enable_wet_filament_purge'
                )
                strs = (
        ...
        self.configurable_options = [
            ...
            {"time_zone": {
                ...
                "value": "America/Vancouver", "callback": screen.change_time_zone, "options": [
                    ...
                    {"name": _("(UTC-01:00)"), "value": "Etc/GMT+1"},
                    {"name": _("(UTC)"), "value": "Etc/GMT"},
                    {"name": _("(UTC+01:00)"), "value": "Etc/GMT-1"},
                    {"name": _("(UTC+02:00)"), "value": "Etc/GMT-2"},
                    {"name": _("(UTC+03:00)"), "value": "Etc/GMT-3"},
                    {"name": _("(UTC+04:00)"), "value": "Etc/GMT-4"},
